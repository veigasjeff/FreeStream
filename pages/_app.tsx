...
function MyApp({ Component, pageProps }: AppProps) {
  ...
  useEffect(() => {
    ...
    const loadAdScripts = () => {
      ...
      adScript1.innerHTML = `(function(s){s.dataset.zone='10603079',s.src='gizokraijaw.net/vignette.min.js'})([document.documentElement, document.body].filter(Boolean).pop().appendChild(document.createElement('script')))`;
      document.head.appendChild(adScript1);

      // Load second ad script
  
      const adScript2 = document.createElement('script');
      adScript2.innerHTML = `(function(s){s.dataset.zone='10603075',s.src='https://nap5k.com/tag.min.js'})([document.documentElement, document.body].filter(Boolean).pop().appendChild(document.createElement('script')))`;
    ...
    //   document.head.appendChild(adScript3);
      ...
      clickyScript1.setAttribute('data-id', '101498160');
      ...
      clickyScript2.setAttribute('data-id', '101498160');
      clickyScript2.src = '/e18f05a9ad.js';
