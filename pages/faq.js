...
export default function FAQPage() {
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Yes! Free Streaming is fully responsive and works on smartphones, tablets, laptops, and desktop computers. We recommend Chrome or Safari for best experience."
    },
    {
  ...
  return (
    <>
      <Head>
        <title>FAQ | Free Streaming - Frequently Asked Questions</title>
        <meta name="description" content="Free Streaming FAQ. Get answers to common questions about our streaming service, schedule, and how to watch movies for free." />
        ...
        {/* Open Graph */}
        <meta property="og:title" content="FAQ | Free Streaming" />
        ...
        <div className="container">
          <div className="header">
            ...
            <p className="description">
              Find quick answers to common questions about Free Streaming
            </p>
          </div>
