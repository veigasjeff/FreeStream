...
export default function ContactPage() {
  return (
    <>
      <Head>
        <title>Contact Us | FreeStream Cinema Support</title>
        <meta name="description" content="Contact FreeStream Cinema for support, streaming issues, or partnership inquiries. We're here to help 24/7." />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "Article",
              "headline": "Contact FreeStream Cinema Support",
              ...
              "publisher": {
                ...
                "logo": {
                  "@type": "ImageObject",
                  "url": "https://freestreamcinema.vercel.app/logo.png"
                }
              }
            })
          }}
                ...
                <div className="contact-info-items">
                  <div className="info-item">
                    ...
                    <div className="info-content">
                      <h4>Email</h4>
                      <p>support@freestreamcinema.com</p>
