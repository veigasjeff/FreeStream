...
//   useEffect(() => {
//     const killPopups = () => {
//       // Neutering window.open to return a dummy object
...
//       // If the click is simulated/scripted (common in ad scripts), block it
...
//     // Constant enforcement to override ad-script re-injections
...
//         }
//       } catch (e) { /* Cross-origin block expected */ }
//     }, 500);
...
//             // Attempt autoplay, but if browser blocks it, user must click play
...
//       flexShrink: 0
//     }),
//     // The wrapper for the player needs min-height: 0 to allow the video to shrink if needed
//     // ensuring the footer stays visible
//     playerSection: {
//       flex: '1 1 auto',
//       position: 'relative',
//       backgroundColor: '#000',
...
//   // --- AGGRESSIVE AD & POP-UNDER BLOCKER (RESTORED) ---
//   useEffect(() => {
//     const killPopups = () => {
...
//       };
//       // 2. Silence alerts and confirms which can be used to lock browsers
//       window.alert = function() { return true; };
//       window.confirm = function() { return true; };
//       window.prompt = function() { return null; };
//     };
...
//     // 4. Continuous enforcement loop to fight ad-script re-injections
//     const shieldInterval = setInterval(() => {
//       killPopups();
//       try {
...
//           iframeRef.current.contentWindow.open = function() { return null; };
//         }
//       } catch (e) { /* Cross-origin security block is expected and ignored */ }
//     }, 500);
