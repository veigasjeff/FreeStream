...
//   const [episodes, setEpisodes] = useState([1]);
//   const [iframeLoaded, setIframeLoaded] = useState(false);
//   const [isDubbedActive, setIsDubbedActive] = useState(false);
...
//   // Handle Hindi Dubbed button click
//   const handleDubbedClick = () => {
//     if (show?.dubbedUrl) {
//       if (!isDubbedActive) {
//         setCurrentStreamUrl(show.dubbedUrl);
//         setIsDubbedActive(true);
//         setIframeLoaded(false);
//       } else {
//         setCurrentStreamUrl(show.streamUrl);
//         setIsDubbedActive(false);
//         setIframeLoaded(false);
//       }
//     }
//   };
...
//     },
//     dubbedButton: {
//       background: isDubbedActive ? "#4CAF50" : "#FF9800",
//       color: "#fff",
//       padding: isMobile ? "8px 12px" : "10px 16px",
//       borderRadius: "6px",
//       display: "flex",
...
//               {show?.dubbedUrl && (
//                 <button 
//                   style={styles.dubbedButton} 
//                   onClick={handleDubbedClick}
//                 >
//                   {isDubbedActive ? "Original" : "Hindi Dubbed"}
//                 </button>
//               )}
//             </div>
