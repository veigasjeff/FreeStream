...
//                     <div style={unmuteOverlay}>
//                       <div style={unmutePrompt}>
//                         <FaVolumeMute size={24} />
//                         <p style={{ margin: "10px 0", fontSize: "14px" }}>
//                           Video is muted. Click the volume icon in player controls to unmute.
//                         </p>
//                         <button onClick={unmute} style={unmuteBtn}>
//                           <FaVolumeUp /> UNMUTE NOW
//                         </button>
//                       </div>
//                     </div>
//                   )} */}
