...
import { Radio, ArrowDownCircle, Search, X } from 'lucide-react';
...
const LiveTV: React.FC = () => {
    ...
    "url": "https://freestreaming.vercel.app/live",
     "mainEntity": {
      ...
      "itemListElement": channels.slice(0, 10).map((item, index) => ({
        "@type": "ListItem",
        "position": index + 1,
        "url": `https://freestreaming.vercel.app/watch/tv_live/${item.id}`,
  ...
  return (
    <div className="min-h-screen bg-miraj-black pt-24 pb-20">
      <SEO 
        title="Live TV - Watch News & Entertainment | FreeStream™" 
