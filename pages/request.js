...
export default function RequestMoviePage() {
  ...
  return (
    <>
      <Head>
        <title>Request Movie | Free Streaming - Suggest Movies for Streaming</title>
        <meta name="description" content="Request movies for Free Streaming. Suggest films you want to watch and help shape our streaming schedule. Join our Telegram channel to submit requests." />
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Request Movie | Free Streaming" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebPage",
              "name": "Request Movie",
              "description": "Request movies for Free Streaming streaming service",
              "publisher": {
                "@type": "Organization",
                "name": "Free Streaming"
              }
