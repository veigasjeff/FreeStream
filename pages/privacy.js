...
export default function PrivacyPolicyPage() {
  return (
    <>
      <Head>
        <title>Privacy Policy | Free Streaming - Data Protection & Privacy</title>
        <meta name="description" content="Free Streaming Privacy Policy. Learn how we protect your data, our cookie policy, and your privacy rights when using our streaming service." />
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Privacy Policy | Free Streaming" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebPage",
              "name": "Privacy Policy",
              "description": "Privacy Policy for Free Streaming",
              "publisher": {
                "@type": "Organization",
                "name": "Free Streaming"
              }
        ...
        <div className="container">
          ...
          <div className="content-card">
            ...
            <div className="section-content">
              <p>At Free Streaming, we respect your privacy. We collect minimal information to provide and improve our service:</p>
          ...
          <div className="content-card">
            ...
            <div className="section-content">
              ...
              <p>Your continued use of Free Streaming after changes constitutes acceptance of the updated policy.</p>
            </div>
          </div>
