...
const Home: React.FC<HomePageProps> = ({ trending, popularMovies, topRatedTV, heroItems }) => {
  ...
  const schema = {
    ...
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://freestreaming.vercel.app/search?q={search_term_string}",
  ...
  return (
    <div className="min-h-screen bg-miraj-black pb-20">
      <SEO 
        title="FreeStream™" 
        description="FreeStream™ - Official Site for free Movie and Tv Shows in HD quality. No registration required."
        schema={schema}
      />
