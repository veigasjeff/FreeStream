...
export default function TermsOfServicePage() {
  return (
    <>
      <Head>
        <title>Terms of Service | Free Streaming - User Agreement & Terms</title>
        <meta name="description" content="Free Streaming Terms of Service. Read our user agreement, terms of use, and legal conditions for using our streaming platform." />
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Terms of Service | Free Streaming" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Terms of Service for Free Streaming",
              "publisher": {
                "@type": "Organization",
                "name": "Free Streaming"
              }
        ...
        <div className="container">
          <div className="header">
            ...
            <p className="description">
              Please read these Terms of Service carefully before using Free Streaming.
            </p>
          </div>
          ...
          <div className="content-card">
            ...
            <div className="section-content">
              <p>By accessing or using Free Streaming, you agree to be bound by these Terms of Service.</p>
          ...
          <div className="content-card">
            ...
            <div className="section-content">
              ...
              <p>Free Streaming is a free streaming platform. We don't charge users for access to our service.</p>
            </div>
          </div>
          ...
          <div className="content-card">
            ...
            <div className="section-content">
              <h3>Our Rights</h3>
              <ul>
                <li>Free Streaming name and logo are our trademarks</li>
          ...
          <div className="content-card">
            ...
            <div className="section-content">
              <p>Free Streaming shall not be liable for:</p>
              <ul>
