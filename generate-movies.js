...
<head>
    ...
    <title>Watch ${movie.title} (${year}) Online Free | HD Streaming | FreeStream</title>
    ...
    <meta property="og:url" content="https://freestream.vercel.app/movies/${movie.id}/">
...
const baseUrl = 'https://freestream.vercel.app';
