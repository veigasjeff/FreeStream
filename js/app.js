    ...
    featuredMoviesEl.innerHTML = featured.map(movie => {
        ...
        return `
            <div class="featured-card" data-id="${movie.id}">
                ...
                <img src="${movie.poster}" alt="${movie.title}" style="object-fit: fill;"
    ...
    liveChannelsEl.innerHTML = initialChannels.map(channel => `
        <div class="live-channel">
            <div class="channel-header">
                <img src="${channel.logo}" alt="${channel.name}" style="object-fit: fill;"
...
// Close modals - Only with X button
...
// REMOVED: Close modals on outside click - This is what was causing the issue
