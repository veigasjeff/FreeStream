      ...
      <div className='container mx-auto px-4 md:px-6'>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12'>
          ...
          <div className='space-y-4'>
            ...
            <p className='text-gray-400 text-sm leading-relaxed'>
              Your premium destination for HD streaming. Watch thousands of
              movies, TV shows, and live sports events for free. No subscription
              required.
            </p>
        ...
        <div className='border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4'>
          <p className='text-gray-500 text-sm text-center md:text-left whitespace-nowrap'>
            © {new Date().getFullYear()} FreeStream™. All rights
            reserved.
          </p>
